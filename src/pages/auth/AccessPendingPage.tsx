...
export function AccessPendingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0D1117] light:bg-bg flex items-center justify-center px-4">
      <div
        className="w-full max-w-sm bg-surface border border-border rounded-2xl overflow-hidden text-center light:[box-shadow:var(--shadow-elevated)]"
        style={{ boxShadow: '0 1px 2px rgba(0,0,0,0.4),0 8px 24px rgba(0,0,0,0.4)' }}
      >
        <div className="px-8 py-8 space-y-5">
          {/* Icon */}
          <div className="flex justify-center">
            <span className="w-14 h-14 rounded-2xl bg-amber-950/40 border border-amber-700/40 inline-flex items-center justify-center light:bg-amber-50 light:border-amber-200">
              <Icon name="clock" size={24} className="text-amber-400 light:text-amber-700" />
            </span>
          </div>
