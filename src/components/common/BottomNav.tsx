  ...
  return (
    <nav
      className={[
        ...
        'pt-2',
        // Fixed total height = the --bottomnav-height (+ safe-area) clearance
        // reserved by .app-shell-content's bottom padding → content ends
        // exactly at nav top. Single source: index.css :root.
        'h-[calc(var(--bottomnav-height)_+_env(safe-area-inset-bottom,_0px))]',
