  ...
  return ReactDOM.createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 max-md:items-end max-md:p-0">
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        className={`relative w-full ${width} bg-surface rounded-2xl shadow-2xl shadow-slate-900/20 light:shadow-slate-300/50 border border-border/60 anim-modal-pop overflow-hidden max-md:rounded-t-[18px] max-md:rounded-b-none max-md:max-w-full max-md:max-h-[85dvh] max-md:overflow-y-auto`}
      >
